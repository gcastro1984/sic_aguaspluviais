...
import { criarAlertaPlanoAcao, obterAlertasPlanos, obterAlertaPlanoAcaoPorIds, atualizarAlertaPlanoAcao, deletarAlertaPlanoAcao } from '../controllers/alerta_plano_acao.controller.js';
...
router.get('/',    verifyToken, obterAlertasPlanos);
...
router.delete('/:idalerta/:idplano_acao', verifyToken, writeRoles, deletarAlertaPlanoAcao);
